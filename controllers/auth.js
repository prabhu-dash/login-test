...
exports.register = (req, res) => {
    ...
    db.query('SELECT Registration FROM userspectrum WHERE Registration = ?', [registration], async (error, results) => {
        ...
        db.query('INSERT INTO userspectrum SET ? ', {Name: name,Email: email,Contact: contact,Branch: branch,Registration: registration,Password: hashed,Domain: domain}, (error, _result) => {
            if(error)
            {
                console.log(error);
            } else {
